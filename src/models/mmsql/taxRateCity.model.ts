// src/models/TaxRates_City.ts
import { Model, DataTypes } from 'sequelize';
import { sequelize } from '../../db';

export class TaxRates_City extends Model {}

TaxRates_City.init(
  {
    Jurisdiction_City: { type: DataTypes.INTEGER,primaryKey:true, allowNull: true },
