...
router.get('/highDemandItems',catchAsync(dashboardController.getHighDemandItems.bind(dashboardController)));
router.post('/epickDashboard',catchAsync(dashboardController.getEpickDashboard.bind(dashboardController)));
router.post('/pickerPerformance',catchAsync(dashboardController.getPickerPerformance.bind(dashboardController)));
router.post('/epickOrderStatistics',catchAsync(dashboardController.getEpickOrderStatistics.bind(dashboardController)));
router.post('/epickTotalOrdersList',catchAsync(dashboardController.getEpickTotalOrdersList.bind(dashboardController)));
router.post('/epickPendingOrdersList',catchAsync(dashboardController.getEpickPendingOrdersList.bind(dashboardController)));
router.post('/epickCompletedOrdersList',catchAsync(dashboardController.getEpickCompletedOrdersList.bind(dashboardController)));
