...
router.post('/getPriceBookInventoryItems/:customerId', verifyRole(ROLES.CHECKER, ROLES.SALES), verifySalesSession, catchAsync(listController.getPriceBookInventoryItems.bind(listController)));
...
router.get('/customerLastBalance/:customerNumber', verifyRole(ROLES.SALES), catchAsync(listController.getCustomerLastBalance.bind(listController)));
