...
router.get('/newItemsManualSetting', verifyRole(ROLES.MANAGER, ROLES.SALES), catchAsync(managerController.getNewItemsManualSetting.bind(managerController)));
router.put('/newItemsManualSetting', verifyRole(ROLES.MANAGER, ROLES.SALES), validateRequest(manualItemsSettingSchema), catchAsync(managerController.updateNewItemsManualSetting.bind(managerController)));
router.get('/popularItemsModeSetting', verifyRole(ROLES.MANAGER, ROLES.SALES), catchAsync(managerController.getPopularItemsModeSetting.bind(managerController)));
router.put('/popularItemsModeSetting', verifyRole(ROLES.MANAGER, ROLES.SALES), validateRequest(popularItemsModeSettingSchema), catchAsync(managerController.updatePopularItemsModeSetting.bind(managerController)));
...
router.get('/invoiceReprint', verifyRole(ROLES.MANAGER, ROLES.SALES), catchAsync(managerController.getInvoiceReprint.bind(managerController)));
...
// Cancelled Stops routes
router.get('/cancelled-stops', verifyRole(ROLES.MANAGER, ROLES.SALES), catchAsync(managerController.getCancelledStops.bind(managerController)));
router.put(
  '/cancel-stop/:stopId',
  verifyRole(ROLES.MANAGER, ROLES.SALES),
  validateRequest(managerCancelStopBodySchema),
  catchAsync(managerController.cancelStop.bind(managerController))
);
