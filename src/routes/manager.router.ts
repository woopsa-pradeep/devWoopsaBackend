...
router.put('/updateRetailer/:id', verifyRole(ROLES.MANAGER), catchAsync(managerController.updateRetailer.bind(managerController)));
// Link CRUD routes
...
router.post('/retailer-location', verifyRole(ROLES.MANAGER), validateRequest(createRetailerLocationSchema), catchAsync(managerController.createRetailerLocation.bind(managerController)));
router.get('/retailer-location', verifyRole(ROLES.MANAGER), validateRequest(getRetailerLocationQuerySchema), catchAsync(managerController.getAllRetailerLocations.bind(managerController)));
router.get('/retailer-location/:id', verifyRole(ROLES.MANAGER), catchAsync(managerController.getRetailerLocationById.bind(managerController)));
router.put('/retailer-location/:id', verifyRole(ROLES.MANAGER), validateRequest(updateRetailerLocationSchema), catchAsync(managerController.updateRetailerLocation.bind(managerController)));
router.delete('/retailer-location/:id', verifyRole(ROLES.MANAGER), catchAsync(managerController.deleteRetailerLocation.bind(managerController)));
